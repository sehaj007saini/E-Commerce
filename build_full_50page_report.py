...
def build_exhaustive_report():
    ...
    c11.paragraphs[0].add_run("Sahibjit Singh (Roll No. 2411789)\nSargun Singh (Roll No. 2411799)")
    ...
    add_p("This is to certify that Mr. Sahibjit Singh (Roll No. 2411789) and Mr. Sargun Singh (Roll No. 2411799), students of Bachelor of Technology in Computer Science & Engineering at Amritsar Group of Colleges, have successfully completed their Summer Training (AGCS-21510) from 4th June 2026 to 10th July 2026.")
    ...
    p_dec_sig.add_run("Sahibjit Singh (Roll No. 2411789)\nSargun Singh (Roll No. 2411799)\nBranch: Computer Science & Engineering\nAmritsar Group of Colleges")
...
public String getAiResponse(String userQuery) {
    ...
    # Save document
    output_path = os.path.join("f:\\SummerProject", "SpringEcom_Project_Report.docx")
    doc.save(output_path)
    print(f"Report generated successfully at: {output_path}")

if __name__ == "__main__":
    build_exhaustive_report()
